  ...
  return (
    <>
      <motion.section
        ...
        className={`flex items-start justify-center px-4 sm:px-6 md:px-8 pb-2 pt-10 transition-colors duration-300 overflow-hidden ${
      ...
      >
        <div className="max-w-2xl w-full mx-auto text-center">
          ...
          >
            ...
            >
              <a
                href="https://www.aetheronai.in/"
                target="_blank"
                className="flex gap-1 items-center underline underline-offset-4"
              >
                <img
                  src="/aetheron_logo.png"
                  alt="Aetheron.ai"
                  className=" w-15 mr-2"
                />
          ...
          >
            ...
            >
              ...
              >
                Forward Deployed Engineer (FDE), May 2026 - Present
              </span>
            </motion.p>
          </motion.div>
          ...
          <motion.div
            variants={itemVariants}
            className="mt-16 space-y-6 w-full max-w-full"
          >
            <h2
            ...
            {/* THE ARCHIVIST'S ENTRY - BLOG CARD (COMPRESSED) */}
            <motion.div
            ...
            >
              <motion.div
                ...
                whileHover={{
                  ...
                  rotate: 0,
                  boxShadow: isDark
                    ? "8px 8px 0px 0px rgba(255,255,255,0.12)"
                    : "8px 8px 0px 0px rgba(0,0,0,0.18)",
              ...
              >
                ...
                {/* Top file tabs */}
                <div className="absolute top-0 left-0 right-0 flex gap-1 px-4 sm:px-5 pt-2 sm:pt-3">
                  <motion.div
                ...
                {/* Red thread SVG - Shortened */}
                <svg
                  className="absolute top-0 left-1/2 -translate-x-1/2 w-0.5 h-6 sm:h-8 pointer-events-none"
                  viewBox="0 0 2 32"
                ...
                {/* Content - Compressed padding */}
                <div className="relative z-10 p-4 sm:p-5 flex flex-col items-start w-full">
                  {/* Catalog stamp */}
                  <motion.div
                    className={`absolute top-2 sm:top-3 right-4 sm:right-5 font-mono text-[9px] sm:text-[10px] tracking-widest uppercase ${
                  ...
                  {/* Title - Tighter margin, slightly smaller text on mobile */}
                  <h3
                    className={`text-lg sm:text-xl md:text-2xl font-bold tracking-tight leading-tight mt-1 mb-1.5 sm:mb-2 text-left w-full ${
                      isDark ? "text-[#e5e5e0]" : "text-[#1a1a1a]"
                    }`}
                  >
                    <Link
                      href="/blogs/blog1"
                      className="group inline-block relative max-w-[85%]"
                    >
                  ...
                  {/* Description - Clamped to 2 lines to save vertical space */}
                  <p
                    className={`text-xs sm:text-sm leading-snug text-left w-full line-clamp-2 ${
                  ...
                  {/* Bottom metadata row - Aligned in a tight flex row */}
                  <div className="mt-3 sm:mt-4 flex items-center justify-between w-full">
                    ...
                    {/* Magnetic read more - Scaled down */}
                    <motion.div
                  ...
                  <motion.div
                    className={`absolute bottom-0 left-0 h-[2px] sm:h-[3px] ${
                      isDark ? "bg-[#ff6b6b]" : "bg-[#c41e3a]"
                    }`}
                    initial={{ width: "0%" }}
            ...
            <Link
              href="/blogs"
              className={`inline-block text-xs sm:text-sm font-medium underline underline-offset-4 hover:opacity-80 transition-opacity mt-2 ${
